...
def divide(const, data, mutation, sim_env, nr_alive, t, still_in_cycle, environment):
    ...
    if nr_divide:
        ...
        sim_env, mutation, nr_mutate = mutate(const, data, mutation, sim_env, nr_divide, to_birth, to_divide_nz, environment)
        nr_alive += nr_divide
    else:
        nr_mutate = nr_divide

    return nr_alive, sim_env, mutation, still_in_cycle, nr_mutate
...
def mutate(const, data, mutation, sim_env, nr_divide, to_birth, to_divide_nz, environment):
    ...
    return sim_env, mutation, nr_mutate
...
def run(func, const, data, environment, sim_env, mutation):
    ...
    return save, mutation, tot_nr_mutate
...
if __name__ == "__main__": # \todo Create functions
    ...
    save, mutation, tot_nr_mutate = run(func, const, data, environment, sim_env, mutation)
    ...
    save.append(('tot_nr_mutate', tot_nr_mutate))
